...
`).join(""),u.refresh()}const y=document.querySelector(".search-form"),l=document.querySelector(".loader"),h=document.querySelector(".gallery");y.addEventListener("submit",s=>{s.preventDefault();const r=s.target.elements.searchQuery.value.trim();if(!r){n.show({messageColor:"#fff",iconColor:"#fff",iconUrl:"/goit-js-hw-11/img/bi_x-octagon.svg",title:"",message:"Please enter a search query!",position:"topRight"});return}l.style.display="block",h.innerHTML="",p(r).then(o=>{m(o)}).catch(o=>{n.show({messageColor:"#fff",color:"#fff",iconColor:"#fff",iconUrl:"/goit-js-hw-11/img/bi_x-octagon.svg",backgroundColor:"#ef4040",title:"",message:"Sorry, there are no images matching <br> your search query. Please try again!",position:"topRight",maxWidth:"432px",borderBottom:"2px solid #ffbebe",borderRadius:"4px",titlecolor:"#fff",top:"20px",right:"20px"})}).finally(()=>{l.style.display="none"}),s.target.reset()});
